...
public class Planet {
    ...
    private ArrayList<Ocean> linkListOcean = new ArrayList<Ocean>();
    private ArrayList<Continent> linkListContinent = new ArrayList<Continent>();
    private ArrayList<Island> linkListIsland = new ArrayList<Island>();
